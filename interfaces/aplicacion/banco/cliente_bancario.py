...
class ClienteBancario:
    ...
    #=============================================================
    # Método privado que checa si el valance es negativo
    # y genera un erro 
    #===========================================================
    def __validarCantidad(self,balanceDeCuenta)->None:
    ...
    def guardarDinero(self,cantidad:float)->None:
        self.__balanceDeCuenta = self._balanceDeCuenta + cantidad
