...
import mathplotlib.patches as patches
...
def subduvision_recursiva(nodo:Nodo,k:int):
    ...
    subdivicion_rucursividad(nodo.x3,k)
...
class QTree():
    ...
    def subdividir(self):
        subdivision_recursiva(sefl.root,self.umbral)
    ...
    def visualizacion(self):
        ...
        for n in c:
            plt.gc().gca().add_patch(patches.Rectangle((n.x0,n.y0),n.ancho,n.alto,fill=False)
